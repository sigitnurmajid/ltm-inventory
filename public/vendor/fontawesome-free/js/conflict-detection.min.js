...
;(e = this),
  (t = function (e) {
    ...
    s &&
      ((d = (u.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(u.readyState)) ||
                              ...
                              (s = g(
                                (s = m(
                                        ...
                                        (s = d(
                                          (s = d(
                                            ...
                                            (f = d(
                                              ...
                                              (l = d(
                                                l,
                                                (a = d(a, s, f, l, e[n + 8], 7, 1770035416)),
                                                s,
                                                f,
                                                e[n + 9],
                                                12,
                                          ...
                                          (f = d(
                                            ...
                                            (l = d(
                                              l,
                                              (a = d(a, s, f, l, e[n + 12], 7, 1804603682)),
                                              s,
                                              f,
                                              e[n + 13],
                                              12,
                                  ...
                                  (f = m(
                                    ...
                                    (l = m(
                                      l,
                                      (a = m(a, s, f, l, e[n + 13], 5, -1444681467)),
                                      s,
                                      f,
                                      e[n + 2],
                                      9,
            ...
            function i(e, t) {
              return (function (e, t) {
                var n,
                  ...
                  c = []
                for (
                  i[15] = c[15] = void 0, 16 < r.length && (r = s(r, 8 * e.length)), n = 0;
                  n < 16;
                  n += 1
                )
