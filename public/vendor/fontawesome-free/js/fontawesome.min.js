...
!(function () {
  ...
  m &&
    ((V = (b.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(b.readyState)) ||
  ...
  function se(t) {
    ...
    return (
      ...
      o.prefix && 1 < i.length
        ...
        : o.prefix && 1 === i.length && (o.iconName = Bt(o.prefix, Ft(t.innerText))),
      o
    )
  }
  var le = function (t) {
      ...
      children: [
        pe,
        {
          ...
          children: [
            {
              tag: 'animate',
              attributes: $({}, me, { attributeName: 'r', values: '28;14;28;28;14;28;' }),
            },
  ...
  function be(t) {
    ...
    return {
      ...
      icon: Array.isArray(a)
        ? {
            tag: 'g',
            attributes: { class: ''.concat(et.familyPrefix, '-').concat(Y.GROUP) },
            children: [
              {
                tag: 'path',
                attributes: {
    ...
    return new vt(function (a, t) {
      ...
      if (r && 'none' !== o && '' !== o) {
        var c = n.getPropertyValue('content'),
          s = ~['Solid', 'Regular', 'Light', 'Duotone', 'Brands', 'Kit'].indexOf(r[2])
            ? E[r[2].toLowerCase()]
            : R[i],
          ...
          return Ee($({ type: 'icon' }, t), function () {
            return (
              ...
              jt({
                icons: {
                  main: be(k),
                  mask: c ? be(c.icon) : { found: !1, width: null, height: null, icon: {} },
                },
                prefix: w,
                iconName: x,
                transform: $({}, yt, a),
  ...
  !(function (t) {
    ...
    u &&
      ...
      X(function () {
        He(), ce({ treeCallback: ke, nodeCallback: Ae, pseudoElementsCallback: Se })
      })),
      (W.hooks = $({}, W.hooks, {
