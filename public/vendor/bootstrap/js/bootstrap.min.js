...
!(function (t, e) {
  ...
  o
    .default(document)
    .on('click.bs.alert.data-api', '[data-dismiss="alert"]', h._handleDismiss(new h())),
  ...
  o
    .default(document)
    .on('click.bs.carousel.data-api', '[data-slide], [data-slide-to]', w._dataApiClickHandler),
            ...
            if ((o.default(this._element).trigger(a), !a.isDefaultPrevented())) {
              ...
              o.default(this._element).removeClass('collapse').addClass('collapsing'),
                ...
                this._triggerArray.length &&
                  o.default(this._triggerArray).removeClass('collapsed').attr('aria-expanded', !0),
            ...
            if ((o.default(this._element).trigger(e), !e.isDefaultPrevented())) {
              ...
              if (i > 0)
                for (var a = 0; a < i; a++) {
                  ...
                  if (null !== l)
                    o.default([].slice.call(document.querySelectorAll(l))).hasClass('show') ||
        ...
        (e._getOffset = function () {
          ...
          return (
            'function' == typeof this._config.offset
              ? (e.fn = function (e) {
                  return (
                    (e.offsets = r({}, e.offsets, t._config.offset(e.offsets, t._element) || {})), e
                  )
                })
          ...
          if (
            ...
            if (i || 27 !== e.which) {
              if ((e.preventDefault(), e.stopPropagation(), !i || 27 === e.which || 32 === e.which))
                return (
                  27 === e.which &&
                    o.default(n.querySelector('[data-toggle="dropdown"]')).trigger('focus'),
      ...
      return (
        ...
        (e.setElementContent = function (t, e) {
          'object' != typeof e || (!e.nodeType && !e.jquery)
            ? this.config.html
              ? (this.config.sanitize && (e = U(e, this.config.whiteList, this.config.sanitizeFn)),
                t.html(e))
              : t.text(e)
            : this.config.html
        ...
        (e._getOffset = function () {
          ...
          return (
            'function' == typeof this.config.offset
              ? (e.fn = function (e) {
                  return (
                    (e.offsets = r({}, e.offsets, t.config.offset(e.offsets, t.element) || {})), e
                  )
                })
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              ...
              (i || ((i = new t(this, a)), n.data('bs.tooltip', i)), 'string' == typeof e)
            ) {
              if ('undefined' == typeof i[e]) throw new TypeError('No method named "' + e + '"')
              i[e]()
            }
  ...
  var at = 'scrollspy',
    ...
    ut = (function () {
      ...
      return (
        ...
        (e._getConfig = function (t) {
          if (
            'string' != typeof (t = r({}, lt, 'object' == typeof t && t ? t : {})).target &&
  ...
  var ct = o.default.fn.toast,
    ...
    mt = (function () {
      ...
      return (
        ...
        (e._getConfig = function (t) {
          return (
            (t = r({}, gt, o.default(this._element).data(), 'object' == typeof t && t ? t : {})),
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            var n = o.default(this),
              i = n.data('bs.toast')
            if (
              (i || ((i = new t(this, 'object' == typeof e && e)), n.data('bs.toast', i)),
              'string' == typeof e)
            ) {
              if ('undefined' == typeof i[e]) throw new TypeError('No method named "' + e + '"')
              i[e](this)
