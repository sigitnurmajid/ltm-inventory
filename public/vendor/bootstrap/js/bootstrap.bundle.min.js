...
!(function (t, e) {
  ...
  i
    .default(document)
    .on('click.bs.alert.data-api', '[data-dismiss="alert"]', d._handleDismiss(new d())),
      ...
      return (
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (n || ((n = new t(this, o)), i.default(this).data('bs.carousel', n)),
              'number' == typeof e)
            )
              n.to(e)
  ...
  i
    .default(document)
    .on('click.bs.carousel.data-api', '[data-slide], [data-slide-to]', y._dataApiClickHandler),
  ...
  function M(t, e) {
    ...
    if ((t !== l && e !== l) || i.contains(o))
      return 'BODY' === (s = (a = l).nodeName) || ('HTML' !== s && R(a.firstElementChild) !== a)
        ? R(l)
        : l
    var u = H(t)
  ...
  function gt() {
    this.state.eventsEnabled ||
      (this.state = mt(this.reference, this.options, this.state, this.scheduleUpdate))
  }
  function vt() {
    var t, e
    this.state.eventsEnabled &&
        ...
        a = function (t, n) {
          ...
          s.forEach(function (t) {
            ;(function (t, e) {
              ...
              if (-1 !== e.indexOf(n))
                return (
                  -1 === Bt.indexOf(n) || Boolean(t.nodeValue.match(Wt) || t.nodeValue.match(Ut))
                )
              for (
        ...
        (e._getOffset = function () {
          ...
          return (
            'function' == typeof this.config.offset
              ? (e.fn = function (e) {
                  return (
                    (e.offsets = a({}, e.offsets, t.config.offset(e.offsets, t.element) || {})), e
                  )
                })
        ...
        (o._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              ...
              (e || ((e = new o(this, n)), i.default(this).data('bs.popover', e)),
              'string' == typeof t)
            ) {
