...
;(function (h) {
  ...
  function $(a) {
    ...
    h.each(a, function (e) {
      if (
        ...
        (c = e.replace(b[0], b[2].toLowerCase())), (d[c] = e), 'o' === b[1] && $(a[e])
    })
    a._hungarianMap = d
  }
  function J(a, b, c) {
  ...
  function Ia(a) {
    ...
    for (f = b.length; e < f; e++)
      if (((m = b[e]), (s = []), !m.sType && m._sManualType)) m.sType = m._sManualType
      else if (!m.sType) {
        g = 0
      ...
      for (e = b.length - 1; 0 <= e; e--) {
        ...
        for (g = q.length; f < g; f++)
          if ('number' === typeof q[f] && 0 <= q[f]) {
            ...
            d(q[f], n)
          } else if ('number' === typeof q[f] && 0 > q[f]) d(m.length + q[f], n)
      ...
      G = function (a) {
        if (c === k || c === i)
          (j = m[i]),
            (h = a.innerHTML.trim()),
            j && j._bAttrSrc
              ? (N(j.mData._)(d, h), s(j.mData.sort, a), s(j.mData.type, a), s(j.mData.filter, a))
              : q
    ...
    for (c = m.length; b < c; b++)
      (f = m[b]),
        ...
        a.oFeatures.bSort &&
          ...
          !1 !== f.bSortable &&
            (d.attr('tabindex', a.iTabIndex).attr('aria-controls', a.sTableId), Oa(a, f.nTh, b))),
      ...
      if (0 !== i.length) {
        ...
        (c = f.sZeroRecords),
          ...
          (b[0] = h('<tr/>', { class: e ? d[0] : '' }).append(
            h('<td />', { valign: 'top', colSpan: W(a), class: a.oClasses.sRowEmpty }).html(c)
          )[0])
    ...
    for (var f = a.sDom.split(''), g, j, i, n, m, q, k = 0; k < f.length; k++) {
      ...
      if ('<' == j) {
        ...
        if ("'" == n || '"' == n) {
          ...
          ;-1 != m.indexOf('.')
            ? ((n = m.split('.')), (i.id = n[0].substr(1, n[0].length - 1)), (i.className = n[1]))
            : '#' == m.charAt(0)
  ...
  function rb(a) {
    var b = a.oClasses,
      ...
      b = h('<div/>', { id: !f.f ? c + '_filter' : null, class: b.sFilter }).append(
        h('<label/>').append(j)
      ),
      i = function () {
    ...
    i = h('<div/>', { class: f.sScrollWrapper })
      ...
      .append(
        h('<div/>', { class: f.sScrollBody })
          .css({ position: 'relative', overflow: 'auto', width: !d ? null : w(d) })
          .append(b)
      )
    m &&
      i.append(
        h('<div/>', { class: f.sScrollFoot })
          .css({ overflow: 'hidden', border: 0, width: d ? (!d ? null : w(d)) : '100%' })
          .append(
  ...
  function ma(a) {
    ...
    if (a.scrollBarVis !== L && a.scrollBarVis !== k) (a.scrollBarVis = L), aa(a)
      ...
      if ('' === c) {
        t.width = '100%'
        if (V && (p.find('tbody').height() > j.offsetHeight || 'scroll' == m.css('overflow-y')))
      ...
      if (p.outerWidth() < f) {
        ...
        if (V && (j.scrollHeight > j.offsetHeight || 'scroll' == m.css('overflow-y')))
          t.width = w(Q - b)
  ...
  function Ha(a) {
    ...
    if (d || (!s && !f && !e && j == W(a) && j == n.length))
      for (l = 0; l < j; l++) (i = ba(a, l)), null !== i && (c[i].sWidth = w(n.eq(l).width()))
    else {
      ...
      for (l = 0; l < i.length; l++)
        (o = c[i[l]]),
          (n[l].style.width = null !== o.sWidthOrig && '' !== o.sWidthOrig ? w(o.sWidthOrig) : ''),
          o.sWidthOrig &&
            f &&
            h(n[l]).append(
              h('<div/>').css({ width: o.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 })
            )
      if (a.aoData.length)
        for (l = 0; l < i.length; l++)
      ...
      for (l = e = 0; l < i.length; l++)
        (k = h(n[l])),
          ...
          (k = p.bBounding ? Math.ceil(n[l].getBoundingClientRect().width) : k.outerWidth()),
          (e += k),
          (c[i[l]].sWidth = w(k - g))
      b.style.width = w(e)
      o.remove()
  ...
  function Kb(a) {
    for (
      var b, c, d = a.aoColumns, e = Y(a), a = a.oLanguage.oAria, f = 0, g = d.length;
      f < g;
      f++
    ) {
      c = d[f]
    ...
    for (e in b)
      b.hasOwnProperty(e) &&
        ...
        h.isPlainObject(d)
          ...
          : (a[e] = c && 'data' !== e && 'aaData' !== e && Array.isArray(d) ? d.slice() : d))
    return a
  }
  function Xa(a, b, c) {
    h(a)
      ...
      this.each(function () {
        ...
        if ('table' != this.nodeName.toLowerCase())
          ...
          p.iInitDisplayStart === k &&
            ((p.iInitDisplayStart = g.iDisplayStart), (p._iDisplayStart = g.iDisplayStart))
          ...
          g.bStateSave
            ? ((V.bStateSave = !0), z(p, 'aoDrawCallback', za, 'state_save'), Lb(p, g, e))
            : e()
        }
      })
      b = null
  ...
  r.register = o = function (a, b) {
    if (Array.isArray(a)) for (var c = 0, d = a.length; c < d; c++) r.register(a[c], b)
    else
      ...
      return this.iterator('table', function (b) {
        ...
        return bb(
          ...
          function (a) {
            ...
            if (h.isPlainObject(a))
              return a.column !== k && a.row !== k && h.inArray(a.row, g) !== -1 ? [a] : []
            c = j
              .filter(a)
              .map(function (a, b) {
  ...
  o('destroy()', function (a) {
    ...
    return this.iterator('table', function (b) {
      ...
      h('th, td', g).removeClass(
        d.sSortable + ' ' + d.sSortableAsc + ' ' + d.sSortableDesc + ' ' + d.sSortableNone
      )
      f.children().detach()
      f.append(m)
      g = a ? 'remove' : 'detach'
  ...
  l.settings = []
  l.models = {}
  l.models.oSearch = { bCaseInsensitive: !0, sSearch: '', bRegex: !1, bSmart: !0 }
  l.models.oRow = {
    nTr: null,
    anCells: null,
    _aData: [],
        ...
        h(a.nTable).on('order.dt.DT', function (e, f, g, h) {
          if (a === f) {
            ...
            b.find('span.' + d.sSortIcon)
              ...
              .addClass(
                h[e] == 'asc' ? d.sSortJUIAsc : h[e] == 'desc' ? d.sSortJUIDesc : c.sSortingClassJUI
              )
          }
        })
      },
