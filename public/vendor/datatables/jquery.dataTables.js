...
;(function (factory) {
  ...
  var DataTable = function (options) {
    ...
    this.fnAddData = function (data, redraw) {
      ...
      var rows =
        Array.isArray(data) && (Array.isArray(data[0]) || $.isPlainObject(data[0]))
          ? api.rows.add(data)
          : api.row.add(data)
  ...
  function _fnScrollDraw(settings) {
    ...
    var bScrolling =
      table.height() > divBodyEl.clientHeight || divBody.css('overflow-y') == 'scroll'
  ...
  function _fnLog(settings, level, msg, tn) {
    ...
    if (tn) {
      msg +=
        '. For more information about this error, please see ' + 'http://datatables.net/tn/' + tn
    }
  ...
  _Api.register = _api_register = function (name, val) {
    ...
    for (i = 0, ien = heir.length; i < ien; i++) {
      ...
      if (i === ien - 1) {
        src.val = val
        src.type =
          typeof val === 'function' ? 'function' : $.isPlainObject(val) ? 'object' : 'other'
      } else {
  ...
  $.each(['column', 'row', 'cell'], function (i, type) {
    _api_register(type + 's().every()', function (fn) {
      ...
      return this.iterator(type, function (settings, arg1, arg2, arg3, arg4) {
        ...
        //  arg4 - loop counter
        fn.call(
          api[type](arg1, type === 'cell' ? arg2 : opts, type === 'cell' ? opts : undefined),
          arg1,
          arg2,
          arg3,
          arg4
