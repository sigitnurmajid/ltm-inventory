...
!(function (t, e) {
  ...
  ;(_.prototype = {
    ...
    (_.prototype.setValues = function (t, e) {
      ...
      if (((a.alpha = Math.max(0, Math.min(1, void 0 === s ? a.alpha : s))), 'alpha' === t))
        return !1
  ...
  Object.defineProperty(K.prototype, 'animationObject', {
    ...
    Y._set('global', {
      animation: { duration: 1e3, easing: 'easeOutQuart', onProgress: B.noop, onComplete: B.noop },
    })
  var Q = {
      animations: [],
      request: null,
      ...
      advance: function () {
        for (var t, e, n, i, a = this.animations, r = 0; r < a.length; )
          (e = (t = a[r]).chart),
            ...
            t.currentStep >= n
              ? (B.callback(t.onAnimationComplete, [t], e), (e.animating = !1), a.splice(r, 1))
              : ++r
      },
    },
  ...
  var wt = X.extend({
      ...
      getCenterPoint: function () {
        var t,
          ...
          n = this._view
        return (
          vt(n) ? ((t = n.x), (e = (n.y + n.base) / 2)) : ((t = (n.x + n.base) / 2), (e = n.y)),
          { x: t, y: e }
        )
      },
      getArea: function () {
  ...
  function li(t, e) {
    ...
    return (
      ...
      null !== o
        ? +o
        : (a || 'function' != typeof r || ((o = r(e)), B.isFinite(o) || (o = n.parse(o))), o)
    )
  }
  function ui(t, e) {
      ...
      e.exports = (function () {
        ...
        function z(t, e, n) {
          var i = '' + Math.abs(t),
            a = e - i.length
          return (
            (t >= 0 ? (n ? '+' : '') : '-') + Math.pow(10, Math.max(0, a)).toString().substr(1) + i
          )
        }
        var E =
        ...
        function pe(t) {
          ...
          return (function (t) {
            for (var e, n, i, a, r = 0; r < t.length; ) {
              for (
                e = (a = ce(t[r]).split('-')).length, n = (n = ce(t[r + 1])) ? n.split('-') : null;
                e > 0;
        ...
        ;(Mn.add = en),
          ...
          (Mn.endOf = function (t) {
            ...
            switch (t) {
              ...
              case 'hour':
                ;(e = this._d.valueOf()),
                  (e += dn - cn(e + (this._isUTC ? 0 : this.utcOffset() * un), dn) - 1)
                break
              case 'minute':
          ...
          (Mn.local = function (t) {
            return (
              this._isUTC &&
                (this.utcOffset(0, t), (this._isUTC = !1), t && this.subtract(Ge(this), 'm')),
              this
            )
          }),
          ...
          (Mn.hasAlignedHourOffset = function (t) {
            return (
              !!this.isValid() &&
              ((t = t ? Le(t).utcOffset() : 0), (this.utcOffset() - t) % 60 == 0)
            )
          }),
          (Mn.isDST = function () {
            return (
          ...
          (Dn.months = function (t, e) {
            return t
              ? r(this._months)
                ...
                : this._months[(this._months.isFormat || Lt).test(e) ? 'format' : 'standalone'][
                    t.month()
                  ]
              : r(this._months)
              ? this._months
        ...
        return (
          ...
          (a.relativeTimeThreshold = function (t, e) {
            return (
              void 0 !== ti[t] &&
              (void 0 === e ? ti[t] : ((ti[t] = e), 's' === t && (ti.ss = e - 1), !0))
            )
          }),
      ...
      afterDatasetsUpdate: function (t, e) {
        ...
        for (i = 0; i < o; ++i)
          (r = null),
            ...
            l.push(r)
        for (i = 0; i < o; ++i)
          (r = l[i]) && ((r.fill = xi(l, i, s)), (r.boundary = yi(r)), (r.mapper = _i(r)))
      },
  ...
  var Li = X.extend({
    ...
    fit: function () {
      ...
      n.display
        ? ((t =
            (B.isArray(n.text) ? n.text.length : 1) * B.options._parseFont(n).lineHeight +
            2 * n.padding),
    ...
    nn.helpers.each(
      ...
      function (t) {
        nn[t] = function (e, n) {
          return new nn(
            e,
            nn.helpers.merge(n || {}, { type: t.charAt(0).toLowerCase() + t.slice(1) })
          )
        }
      }
    ),
